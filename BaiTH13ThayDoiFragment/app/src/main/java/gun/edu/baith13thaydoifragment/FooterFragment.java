package gun.edu.baith13thaydoifragment;
...
public class FooterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Xử lý sự kiện khi nhấn nút ONE [00:15:55]
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                fragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainerView_Content, new Fragment1()) // Thay thế Fragment cũ bằng FragmentOne [00:16:48]
                        .commit();
            }
        });

        // Xử lý sự kiện khi nhấn nút TWO [00:17:24]
        ...
        // Xử lý sự kiện khi nhấn nút THREE [00:17:31]
